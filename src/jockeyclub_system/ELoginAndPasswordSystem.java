 ...
 * @author kingl
 */
public class ELoginAndPasswordSystem {
   ...
   JFrame frame;
    ...
    public ELoginAndPasswordSystem( JPanel userName, JPanel password, JFrame f) {
    ...
    public JPanel usernameGUI(){
        ...
        JLabel userJLabel= new JLabel("EmployeeID:");
        ...
        Action action = new AbstractAction()
{
    ...
    Elogin_database acc1 = new Elogin_database(getusername,getpassword);
    if(acc1.result()==true){
        frame.dispose();
        new ELoginPage(getusername);
